...
public class Employee {
    ...
    protected Employee() {}
    public Employee(String code, String firstName, String lastName, String email, String phone, String title, LocalDate hireDate, Department department, EmploymentStatus status) { this.employeeCode=code; this.firstName=firstName; this.lastName=lastName; this.email=email; this.phone=phone; this.jobTitle=title; this.hireDate=hireDate; this.department=department; if(status!=null) this.status=status; }
